...
RESOURCES += src/qt/lavas.qrc src/qt/lavas_locale.qrc

TRANSLATIONS += src/qt/locale/lavas_bg.ts \
                src/qt/locale/lavas_de.ts \
                src/qt/locale/lavas_en.ts \
                src/qt/locale/lavas_es.ts \
                src/qt/locale/lavas_fi.ts \
                src/qt/locale/lavas_fr.ts \
                src/qt/locale/lavas_it.ts \
                src/qt/locale/lavas_ja.ts \
                src/qt/locale/lavas_pl.ts \
                src/qt/locale/lavas_pt.ts \
                src/qt/locale/lavas_ru.ts \
                src/qt/locale/lavas_sk.ts \
                src/qt/locale/lavas_sv.ts \
                src/qt/locale/lavas_vi.ts \
                src/qt/locale/lavas_zh_CN.ts \
                src/qt/locale/lavas_zh_TW.ts
