...
In order to support loading of multiple wallets in lavas-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is lavas.cpp.
...
Changes to lavas.cpp
----------------------
lavas.cpp is the entry point into lavas-qt, and as such, will require some minor modifications to provide hooks for
