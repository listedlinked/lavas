...
/** Utility functions used by the LAVAS Qt UI.
 */
namespace GUIUtil
{
...
// Render LAVAS addresses in monospace font
...
// Parse "lavas:" URI into recipient object, return true on successful parsing
