...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("LAVAS Core lavas-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  lavas-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lavas transaction") + "\n" +
                               "  lavas-tx [options] -create [commands]   " + _("Create hex-encoded lavas transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded lavas transaction
